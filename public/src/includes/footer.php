<footer class="footer">
    ...
    <div class="container footer-grid">
        ...
        <div class="footer-box">
            <h4>Fale Conosco</h4>
            <p style="margin-bottom: 15px;">contato@anaeletro.com.br</p>
        ...
        <div class="footer-box" id="footer-box">
            ...
            <div class="payment-methods">
                ...
                <div class="payment-item" style="display: flex; align-items: flex-start; gap: 10px;">
                    ...
                    <a class="linkScb" href="https://www.scbcredito.com.br/"><img class="logoScb" src="./img/logo-scb-credito-footer.png" alt="logo SCB Crédito"><br>Exclusivo: Financiamento SCB Crédito</a>
